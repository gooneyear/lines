...
$(function () {
    ...
    $("#next").click(function () {
        ...
        //for(var i=0;i<title.matters.length;i++){
        //    console.log(title.matters[i]);
        //}
        //console.log(title.lianxuwutishiNumber);
        //console.log(title.lianxuErrorNumber);
        ...
        if(title.gameOver==true){
            ...
            $("#meanFyTime").html((title.avgCorrectTime/title.rightNumber).toFixed(2));
